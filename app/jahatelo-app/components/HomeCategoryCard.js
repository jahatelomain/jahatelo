  ...
  <Svg width="100%" height="100%" style={StyleSheet.absoluteFillObject}>
    <Defs>
      <Pattern id="citiesPattern" patternUnits="userSpaceOnUse" width="120" height="120">
        ...
        <Rect x="5" y="70" width="15" height="50" fill="#3d1f5c" opacity="0.5" />
        <Rect x="5" y="68" width="15" height="2" fill="#5a3380" opacity="0.5" />
        <Rect x="25" y="50" width="18" height="70" fill="#3d1f5c" opacity="0.5" />
        <Rect x="25" y="48" width="18" height="2" fill="#5a3380" opacity="0.5" />
        <Rect x="48" y="60" width="14" height="60" fill="#3d1f5c" opacity="0.5" />
        <Rect x="48" y="58" width="14" height="2" fill="#5a3380" opacity="0.5" />
        <Rect x="67" y="45" width="20" height="75" fill="#3d1f5c" opacity="0.5" />
        <Rect x="67" y="43" width="20" height="2" fill="#5a3380" opacity="0.5" />
        <Rect x="92" y="65" width="16" height="55" fill="#3d1f5c" opacity="0.5" />
        <Rect x="92" y="63" width="16" height="2" fill="#5a3380" opacity="0.5" />
        {/* Ventanas pequeñas */}
        <Rect x="8" y="75" width="3" height="4" fill="#8b5fb8" opacity="0.3" />
        <Rect x="14" y="75" width="3" height="4" fill="#8b5fb8" opacity="0.3" />
        <Rect x="8" y="85" width="3" height="4" fill="#8b5fb8" opacity="0.3" />
        <Rect x="14" y="85" width="3" height="4" fill="#8b5fb8" opacity="0.3" />
        <Rect x="30" y="55" width="3" height="4" fill="#8b5fb8" opacity="0.3" />
        <Rect x="37" y="55" width="3" height="4" fill="#8b5fb8" opacity="0.3" />
        <Rect x="30" y="65" width="3" height="4" fill="#8b5fb8" opacity="0.3" />
        <Rect x="37" y="65" width="3" height="4" fill="#8b5fb8" opacity="0.3" />
      </Pattern>
    </Defs>
  ...
  <Svg width="100%" height="100%" style={StyleSheet.absoluteFillObject}>
    <Defs>
      <Pattern id="mapPattern" patternUnits="userSpaceOnUse" width="100" height="100">
        ...
        <Path d="M0,20 Q25,18 50,20 T100,20" stroke="#1e4d6b" strokeWidth="1.5" fill="none" opacity="0.5" />
        <Path d="M0,35 Q25,33 50,35 T100,35" stroke="#1e4d6b" strokeWidth="1.5" fill="none" opacity="0.5" />
        <Path d="M0,50 Q25,48 50,50 T100,50" stroke="#2a6f8f" strokeWidth="2" fill="none" opacity="0.5" />
        <Path d="M0,65 Q25,63 50,65 T100,65" stroke="#1e4d6b" strokeWidth="1.5" fill="none" opacity="0.5" />
        <Path d="M0,80 Q25,78 50,80 T100,80" stroke="#1e4d6b" strokeWidth="1.5" fill="none" opacity="0.5" />
        {/* Puntos de marcadores */}
        <Circle cx="20" cy="35" r="2.5" fill="#3a8fb7" opacity="0.5" />
        <Circle cx="50" cy="50" r="3" fill="#3a8fb7" opacity="0.6" />
        <Circle cx="75" cy="65" r="2.5" fill="#3a8fb7" opacity="0.5" />
        {/* Líneas de grilla sutiles */}
        <Line x1="33" y1="0" x2="33" y2="100" stroke="#1e4d6b" strokeWidth="0.5" opacity="0.3" />
        <Line x1="66" y1="0" x2="66" y2="100" stroke="#1e4d6b" strokeWidth="0.5" opacity="0.3" />
      </Pattern>
    </Defs>
  ...
  <Svg width="100%" height="100%" style={StyleSheet.absoluteFillObject}>
    <Defs>
      <Pattern id="flamePattern" patternUnits="userSpaceOnUse" width="80" height="100">
        ...
        />
        {/* Partículas/chispas */}
        <Circle cx="10" cy="30" r="1.5" fill="#7a4f2f" opacity="0.4" />
        <Circle cx="28" cy="45" r="1" fill="#7a4f2f" opacity="0.3" />
        <Circle cx="52" cy="25" r="1.5" fill="#7a4f2f" opacity="0.4" />
        <Circle cx="70" cy="50" r="1" fill="#7a4f2f" opacity="0.3" />
        <Circle cx="35" cy="15" r="1" fill="#7a4f2f" opacity="0.3" />
        {/* Ondas de calor */}
        <Path d="M0,60 Q10,58 20,60 T40,60 T60,60 T80,60" stroke="#5a2f1f" strokeWidth="0.5" fill="none" opacity="0.3" />
        <Path d="M0,75 Q10,73 20,75 T40,75 T60,75 T80,75" stroke="#5a2f1f" strokeWidth="0.5" fill="none" opacity="0.3" />
      </Pattern>
    </Defs>
