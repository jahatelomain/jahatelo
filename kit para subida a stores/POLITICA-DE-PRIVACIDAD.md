...
- Datos de uso: búsquedas, favoritos, interacciones con contenido.
- Datos de ubicación: solo si el usuario lo autoriza.
- Datos del dispositivo: modelo, sistema operativo, IP aproximada.
- Notificaciones: token push si aceptas recibirlas.
...
Contacto: info@jahatelo.com

9. Menores
El servicio no esta dirigido a personas menores de 18 años. Si detectamos datos de menores,
las cuentas serán eliminadas.

10. Cambios
Podemos actualizar esta política. Si hay cambios relevantes, lo notificaremos.
