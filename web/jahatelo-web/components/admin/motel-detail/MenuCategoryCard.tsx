...
type Props = { category: MenuCategory; onAddItem: (categoryId: string) => void; onDeleteCategory: (categoryId: string) => void; onDeleteItem: (itemId: string) => void };

export default function MenuCategoryCard({ category, onAddItem, onDeleteCategory, onDeleteItem }: Props) {
  return (
